...
while(cv2.waitKey(10) != ord('q')):
    ...
    cv2.imshow("frame", cv2.cvtColor(full_image, cv2.COLOR_BGR2GRAY))
...
print("---------------------------------------------------------------------------")
print("You reached the end of the video. You need more data for a longer video.")
